...
echo "5. Import tshikaji accounts, inventory and dependencies"
mysql -u $DB_USER -p$DB_PASS $DB_NAME < server/models/tshikaji/dependencies.sql
mysql -u $DB_USER -p$DB_PASS $DB_NAME < server/models/tshikaji/account.sql
mysql -u $DB_USER -p$DB_PASS $DB_NAME < server/models/tshikaji/inventory.sql
